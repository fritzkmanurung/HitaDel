...
@section('content')
    ...
    <div class="main" style="padding: 10px 15px 0 15px;">
        ...
        @endif
        <h4 style="text-align: center;">{{ __('Welcome to your home page, ') }} {{ $user->name }}!</h4>
        <div class="container" style="padding: 0 70px 0 10px;">
            <div class="row justify-content-center">
                ...
                @else
                    <i class="fas fa-user-circle" style="font-size: 150px; color: #ccc; margin-top:5vh;"></i>
                @endif
            
                    <h2 class="mt-3">{{ Auth::user()->name }}</h2>
                </div>
                <div class="card-body" style="margin-top:5vh;">
                    <a href="{{ route('create-post') }}" class="btn btn-primary mb-3"
                        style="margin-top:20px; margin-bottom: 5vh; background-color: #1775F1; color: white; border-radius: 14px; font-size: 14px; padding: 12px 16px 12px 16px; font-weight: bold;">Add
                        Post</a>
                            ...
                            <div class="card-body">
                                ...
                                <div class="user-info mt-2" style="margin-top: 20px; display:flex;">
                                    ...
                                    <a href="{{ route('user-profile', $post->user->id) }}">
                                        <img src="{{ asset('storage/' . $post->user->profile_picture) }}" alt="Profile Picture" class="rounded-circle"
                                ...
                                @else
                                    <i class="fas fa-user-circle" style="font-size: 50px; color: #ccc; margin: 15px 20px 0 0;"></i>
                                @endif
                                    <div
                                    ...
                                    box-shadow: 4px 4px 16px rgba(0, 0, 0, .1); padding: 20px 20px 0 20px;">
                                        ...
                                        <div class="head" style="padding: 5px;">
                                            <div>
                                                ...
                                                <br>
                                                <p style="white-space: pre-line; line-height: .8;">{!! nl2br(e($post->description)) !!}</p>
                                                <br>
                                            </div>
                                            <div class="menu">
