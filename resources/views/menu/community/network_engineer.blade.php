            ...
            <div class="row justify-content-center">
                <div class="card-body" style="margin-top:5vh;">
                    <p class="btn btn-primary mb-3"
                        ...
                        margin-top:20px; margin-bottom: 5vh; background-color: #1775F1; color: white; border-radius: 8px; font-size: 18px; padding: 12px 16px 12px 16px; font-weight: bold;">{{ $title }}</p>
                            ...
                            <div class="card-body">
                                ...
                                <div class="user-info mt-2" style="margin-top: 20px; display:flex;">
                                    ...
                                    @else
                                        ...
                                        <div style="width: 50px; height: 50px; border-radius:50%; margin: 15px 20px 0 0; background: #0000; display: flex; align-items: center; justify-content: center;">
                                    ...
                                    box-shadow: 4px 4px 16px rgba(0, 0, 0, .1); padding: 20px 20px 0 20px;">
                                        ...
                                        <div class="head" style="padding: 5px;">
                                            <div>
                                                ...
                                                <br>
                                                <p style="white-space: pre-line; line-height: .8;">{{ $post->description }}</p>
                                                <br>
                                            </div>
                                            <div class="menu">
...
{{-- 
    ...
    .then(data => {
        ...
        newComment.innerHTML = `<div class="head" style="">
            <div>
                <strong style="">
                    <a style="display: flex; align-items:center; color: black" href="/user-profile/${data.comment.user.id}">
        ...
        @can('delete', 'data.comment')
            newComment.innerHTML += `<button style="margin-left:17px; background:white; cursor:pointer;"
